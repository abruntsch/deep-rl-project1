...
This is my solution to the navigation project as part of the Udacity Deep Reinforcement Learning Nanodegree.

### Introduction

In this first project an agent will be trained to navigate and collect yellow bananas while avoiding blue bananas in a large, square world.
...
2. Click on `Navigation Project.ipynb` in the opened browser window to open the notebook containing the training code.

3. Before running the code and thus actually starting the training the link to the banana environment may need to be changed to fit the exact path to the above downloaded and unzipped banana environment.
